...
![](https://github.com/Chekunin/algorithms/blob/master/graph/tree-8.png)  
### Добавление элемента
Новый элемент добавляется на последнее место в массиве (если рассматривать, что дерево представлено в виде массива).  
![](https://github.com/Chekunin/algorithms/blob/master/graph/tree-9.png)  
...
![](https://github.com/Chekunin/algorithms/blob/master/graph/tree-10.png)  
![](https://github.com/Chekunin/algorithms/blob/master/graph/tree-11.png)  
...
![](https://github.com/Chekunin/algorithms/blob/master/graph/tree-12.png)  
...
![](https://github.com/Chekunin/algorithms/blob/master/graph/tree-13.png)  
![](https://github.com/Chekunin/algorithms/blob/master/graph/tree-14.png)  
```golang
